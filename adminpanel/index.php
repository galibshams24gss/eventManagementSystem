              ...
              <div class="panel-body">
                <div class="text-center">
                  <div class="well dash-box">
					...
					<?php } ?>
					<br/><br/>
					<a href="addevent.php" class="btn btn-success">Add Event Details</a><br/>
					<a href="updateevent.php" class="btn btn-warning">Update Event Details</a><br/>
					<a href="deleteevent.php" class="btn btn-danger">Delete Event Details</a><br/>
